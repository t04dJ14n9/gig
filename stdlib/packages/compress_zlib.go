...
func init() {
	...
	// Interface Proxies
	pkg.AddInterfaceProxy("Resetter", reflect.TypeOf((*compress_zlib.Resetter)(nil)).Elem(), []string{"Reset"}, newProxy_compress_zlib_Resetter)
...
type proxy_compress_zlib_Resetter struct {
	call external.InterfaceMethodCaller
}

func newProxy_compress_zlib_Resetter(_ value.Value, _ string, call external.InterfaceMethodCaller) (any, bool) {
	return &proxy_compress_zlib_Resetter{call: call}, true
}

func (p *proxy_compress_zlib_Resetter) Reset(a0 io.Reader, a1 []byte) error {
