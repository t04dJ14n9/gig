...
func init() {
	...
	pkg.AddFunction("Background", context.Background, "", direct_Background)
	pkg.AddFunction("Cause", context.Cause, "", nil)
	pkg.AddFunction("TODO", context.TODO, "", direct_TODO)
...
func direct_Background(args []value.Value) value.Value {
	return value.FromInterface(context.Background())
}

func direct_TODO(args []value.Value) value.Value {
