...
// ============================================================================
// Round 60: Final comprehensive integration test
// ============================================================================
...
func Comprehensive1() int {
	...
	total := 0
	for _, s := range students { total += s.Score }
	avg := total / len(students)
	aboveAvg := 0
	for _, s := range students {
		if s.Score > avg { aboveAvg++ }
	}
...
func Comprehensive2() string {
	...
	for _, w := range words { counts[strings.ToLower(w)]++ }
...
func Comprehensive7() int {
	...
	for i, v := range filtered { doubled[i] = v * 2 }
	sum := 0
