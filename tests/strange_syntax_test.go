...
var strangeSyntaxResolvedIssueSrc string
...
func TestStrangeSyntax(t *testing.T) {
	tests := map[string]testCase{
		...
		"SliceSharedUnderlying":          {strangeSyntaxSrc, "SliceSharedUnderlying", nil, strange_syntax.SliceSharedUnderlying},
		"SliceAppendDoesNotShare":        {strangeSyntaxSrc, "SliceAppendDoesNotShare", nil, strange_syntax.SliceAppendDoesNotShare},
		"SliceAppendSharesBeforeCap":     {strangeSyntaxSrc, "SliceAppendSharesBeforeCap", nil, strange_syntax.SliceAppendSharesBeforeCap},
		"SliceCopySemantics":             {strangeSyntaxSrc, "SliceCopySemantics", nil, strange_syntax.SliceCopySemantics},
		"SliceCopyFromSubslice":          {strangeSyntaxSrc, "SliceCopyFromSubslice", nil, strange_syntax.SliceCopyFromSubslice},
		"DeferNamedReturnMutate":         {strangeSyntaxSrc, "DeferNamedReturnMutate", nil, strange_syntax.DeferNamedReturnMutate},
		"DeferNamedReturnOverride":       {strangeSyntaxSrc, "DeferNamedReturnOverride", nil, strange_syntax.DeferNamedReturnOverride},
		"InterfaceBoxNilSlice":           {strangeSyntaxSrc, "InterfaceBoxNilSlice", nil, strange_syntax.InterfaceBoxNilSlice},
		"InterfaceBoxNilMap":             {strangeSyntaxSrc, "InterfaceBoxNilMap", nil, strange_syntax.InterfaceBoxNilMap},
		"InterfaceBoxNilPointer":         {strangeSyntaxSrc, "InterfaceBoxNilPointer", nil, strange_syntax.InterfaceBoxNilPointer},
		"InterfaceBoxNilFunc":            {strangeSyntaxSrc, "InterfaceBoxNilFunc", nil, strange_syntax.InterfaceBoxNilFunc},
		"InterfaceBoxNilChannel":         {strangeSyntaxSrc, "InterfaceBoxNilChannel", nil, strange_syntax.InterfaceBoxNilChannel},
		"TypeAssertionCommaOKSuccess":    {strangeSyntaxSrc, "TypeAssertionCommaOKSuccess", nil, strange_syntax.TypeAssertionCommaOKSuccess},
		"TypeAssertionCommaOKFailure":    {strangeSyntaxSrc, "TypeAssertionCommaOKFailure", nil, strange_syntax.TypeAssertionCommaOKFailure},
		"MapAccessZeroValue":             {strangeSyntaxSrc, "MapAccessZeroValue", nil, strange_syntax.MapAccessZeroValue},
		"MapAccessBoolZeroValue":         {strangeSyntaxSrc, "MapAccessBoolZeroValue", nil, strange_syntax.MapAccessBoolZeroValue},
		"MapAccessStructZeroValue":       {strangeSyntaxSrc, "MapAccessStructZeroValue", nil, strange_syntax.MapAccessStructZeroValue},
		"MapAccessPointerZeroValue":      {strangeSyntaxSrc, "MapAccessPointerZeroValue", nil, strange_syntax.MapAccessPointerZeroValue},
		"SliceThreeIndexLimit":           {strangeSyntaxSrc, "SliceThreeIndexLimit", nil, strange_syntax.SliceThreeIndexLimit},
		"SliceThreeIndexAppend":          {strangeSyntaxSrc, "SliceThreeIndexAppend", nil, strange_syntax.SliceThreeIndexAppend},
		"RangeValueCopy":                 {strangeSyntaxSrc, "RangeValueCopy", nil, strange_syntax.RangeValueCopy},
		"RangePointerMutation":           {strangeSyntaxSrc, "RangePointerMutation", nil, strange_syntax.RangePointerMutation},
		"ClosureCaptureTiming":           {strangeSyntaxSrc, "ClosureCaptureTiming", nil, strange_syntax.ClosureCaptureTiming},
		"ClosureCaptureByReference":      {strangeSyntaxSrc, "ClosureCaptureByReference", nil, strange_syntax.ClosureCaptureByReference},
		"ShortVarRedeclare":              {strangeSyntaxSrc, "ShortVarRedeclare", nil, strange_syntax.ShortVarRedeclare},
		"ShortVarRedeclareInInnerScope":  {strangeSyntaxSrc, "ShortVarRedeclareInInnerScope", nil, strange_syntax.ShortVarRedeclareInInnerScope},
		"MapDeleteAndAccess":             {strangeSyntaxSrc, "MapDeleteAndAccess", nil, strange_syntax.MapDeleteAndAccess},
		"MapLenAfterDelete":              {strangeSyntaxSrc, "MapLenAfterDelete", nil, strange_syntax.MapLenAfterDelete},
		"StructMethodPointerReceiver":    {strangeSyntaxSrc, "StructMethodPointerReceiver", nil, strange_syntax.StructMethodPointerReceiver},
		"StructMethodValueReceiver":      {strangeSyntaxSrc, "StructMethodValueReceiver", nil, strange_syntax.StructMethodValueReceiver},
		"ChannelCommaOK":                 {strangeSyntaxSrc, "ChannelCommaOK", nil, strange_syntax.ChannelCommaOK},
		"ChannelClosedZeroValue":         {strangeSyntaxSrc, "ChannelClosedZeroValue", nil, strange_syntax.ChannelClosedZeroValue},
		"SwitchCaseBreak":                {strangeSyntaxSrc, "SwitchCaseBreak", nil, strange_syntax.SwitchCaseBreak},
		"SwitchFallthroughLogic":         {strangeSyntaxSrc, "SwitchFallthroughLogic", nil, strange_syntax.SwitchFallthroughLogic},
		"StringIndexByte":                {strangeSyntaxSrc, "StringIndexByte", nil, strange_syntax.StringIndexByte},
		"StringSliceShared":              {strangeSyntaxSrc, "StringSliceShared", nil, strange_syntax.StringSliceShared},
		"ByteSliceModification":          {strangeSyntaxSrc, "ByteSliceModification", nil, strange_syntax.ByteSliceModification},
		"MultipleAssignmentOrder":        {strangeSyntaxSrc, "MultipleAssignmentOrder", nil, strange_syntax.MultipleAssignmentOrder},
		"MultipleAssignmentSwap":         {strangeSyntaxSrc, "MultipleAssignmentSwap", nil, strange_syntax.MultipleAssignmentSwap},
		"NilSliceCompareEmpty":           {strangeSyntaxSrc, "NilSliceCompareEmpty", nil, strange_syntax.NilSliceCompareEmpty},
		"StructComparable":               {strangeSyntaxSrc, "StructComparable", nil, strange_syntax.StructComparable},
		"StructNotComparable":            {strangeSyntaxSrc, "StructNotComparable", nil, strange_syntax.StructNotComparable},
		"PointerComparisonR13":           {strangeSyntaxSrc, "PointerComparisonR13", nil, strange_syntax.PointerComparisonR13},
		"DifferentPointerComparisonR13":  {strangeSyntaxSrc, "DifferentPointerComparisonR13", nil, strange_syntax.DifferentPointerComparisonR13},
		"InterfaceMethodDispatch":        {strangeSyntaxSrc, "InterfaceMethodDispatch", nil, strange_syntax.InterfaceMethodDispatch},
		"InterfaceMethodDispatch2":       {strangeSyntaxSrc, "InterfaceMethodDispatch2", nil, strange_syntax.InterfaceMethodDispatch2},
		"SliceMakeInitialized":           {strangeSyntaxSrc, "SliceMakeInitialized", nil, strange_syntax.SliceMakeInitialized},
		"MapMakeSizeHint":                {strangeSyntaxSrc, "MapMakeSizeHint", nil, strange_syntax.MapMakeSizeHint},
		"NilMapWritePanic":               {strangeSyntaxSrc, "NilMapWritePanic", nil, strange_syntax.NilMapWritePanic},
		"DeferStackOrder":                {strangeSyntaxSrc, "DeferStackOrder", nil, strange_syntax.DeferStackOrder},
		"DeferStackOrderWithNamed":       {strangeSyntaxSrc, "DeferStackOrderWithNamed", nil, strange_syntax.DeferStackOrderWithNamed},
		"SliceAppendGrowth":              {strangeSyntaxSrc, "SliceAppendGrowth", nil, strange_syntax.SliceAppendGrowth},
		"ChannelSelectDefault":           {strangeSyntaxSrc, "ChannelSelectDefault", nil, strange_syntax.ChannelSelectDefault},
		"ChannelSelectNilChannel":        {strangeSyntaxSrc, "ChannelSelectNilChannel", nil, strange_syntax.ChannelSelectNilChannel},
		"GotoSkipVariable":               {strangeSyntaxSrc, "GotoSkipVariable", nil, strange_syntax.GotoSkipVariable},
		"GotoBackwardLoop":               {strangeSyntaxSrc, "GotoBackwardLoop", nil, strange_syntax.GotoBackwardLoop},
		"EmbeddedStructMethodResolution": {strangeSyntaxSrc, "EmbeddedStructMethodResolution", nil, strange_syntax.EmbeddedStructMethodResolution},
		"EmbeddedStructFieldPromotion":   {strangeSyntaxSrc, "EmbeddedStructFieldPromotion", nil, strange_syntax.EmbeddedStructFieldPromotion},
		"TypeAliasMethod":                {strangeSyntaxSrc, "TypeAliasMethod", nil, strange_syntax.TypeAliasMethod},
		"TypeAliasOperator":              {strangeSyntaxSrc, "TypeAliasOperator", nil, strange_syntax.TypeAliasOperator},
		"SliceOfInterfacesAppend":        {strangeSyntaxSrc, "SliceOfInterfacesAppend", nil, strange_syntax.SliceOfInterfacesAppend},
		"MapInterfaceKeyValue":           {strangeSyntaxSrc, "MapInterfaceKeyValue", nil, strange_syntax.MapInterfaceKeyValue},
		"VariadicCallWithSlice":          {strangeSyntaxSrc, "VariadicCallWithSlice", nil, strange_syntax.VariadicCallWithSlice},
		"VariadicCallDirect":             {strangeSyntaxSrc, "VariadicCallDirect", nil, strange_syntax.VariadicCallDirect},
		"VariadicCallEmpty":              {strangeSyntaxSrc, "VariadicCallEmpty", nil, strange_syntax.VariadicCallEmpty},
		"NestedSliceAppendR13":           {strangeSyntaxSrc, "NestedSliceAppendR13", nil, strange_syntax.NestedSliceAppendR13},
		"StringRuneConversion":           {strangeSyntaxSrc, "StringRuneConversion", nil, strange_syntax.StringRuneConversion},
		"StringByteConversion":           {strangeSyntaxSrc, "StringByteConversion", nil, strange_syntax.StringByteConversion},
		"ConstIotaExpressionR13":         {strangeSyntaxSrc, "ConstIotaExpressionR13", nil, strange_syntax.ConstIotaExpressionR13},
		"ConstIotaSkipR13":               {strangeSyntaxSrc, "ConstIotaSkipR13", nil, strange_syntax.ConstIotaSkipR13},
		"BlankIdentifierInForR13":        {strangeSyntaxSrc, "BlankIdentifierInForR13", nil, strange_syntax.BlankIdentifierInForR13},
		"MapValueTypeAssertion":          {strangeSyntaxSrc, "MapValueTypeAssertion", nil, strange_syntax.MapValueTypeAssertion},
		"SliceIndexOutOfRange":           {strangeSyntaxSrc, "SliceIndexOutOfRange", nil, strange_syntax.SliceIndexOutOfRange},
		"ArrayValueSemantics":            {strangeSyntaxSrc, "ArrayValueSemantics", nil, strange_syntax.ArrayValueSemantics},
		"PointerToArrayModify":           {strangeSyntaxSrc, "PointerToArrayModify", nil, strange_syntax.PointerToArrayModify},
		"StructFieldPointerModifyR13":    {strangeSyntaxSrc, "StructFieldPointerModifyR13", nil, strange_syntax.StructFieldPointerModifyR13},
		"InterfaceEmptyTypeAssertion":    {strangeSyntaxSrc, "InterfaceEmptyTypeAssertion", nil, strange_syntax.InterfaceEmptyTypeAssertion},
		"InterfaceDoubleBoxing":          {strangeSyntaxSrc, "InterfaceDoubleBoxing", nil, strange_syntax.InterfaceDoubleBoxing},
		"SliceLiteralNested":             {strangeSyntaxSrc, "SliceLiteralNested", nil, strange_syntax.SliceLiteralNested},
		"MapLiteralNested":               {strangeSyntaxSrc, "MapLiteralNested", nil, strange_syntax.MapLiteralNested},
		"StructLiteralNested":            {strangeSyntaxSrc, "StructLiteralNested", nil, strange_syntax.StructLiteralNested},
		"ForLoopWithContinue":            {strangeSyntaxSrc, "ForLoopWithContinue", nil, strange_syntax.ForLoopWithContinue},
		"ForLoopWithBreak":               {strangeSyntaxSrc, "ForLoopWithBreak", nil, strange_syntax.ForLoopWithBreak},
		"SwitchMultipleCases":            {strangeSyntaxSrc, "SwitchMultipleCases", nil, strange_syntax.SwitchMultipleCases},
		"ComplexSliceReslice":            {strangeSyntaxSrc, "ComplexSliceReslice", nil, strange_syntax.ComplexSliceReslice},
		"NilSliceAppendMultiple":         {strangeSyntaxSrc, "NilSliceAppendMultiple", nil, strange_syntax.NilSliceAppendMultiple},
		"MapIterateCount":                {strangeSyntaxSrc, "MapIterateCount", nil, strange_syntax.MapIterateCount},
		"StructMethodOnNil":              {strangeSyntaxSrc, "StructMethodOnNil", nil, strange_syntax.StructMethodOnNil},
		"ClosureOverwriteVariable":       {strangeSyntaxSrc, "ClosureOverwriteVariable", nil, strange_syntax.ClosureOverwriteVariable},
		"SliceDeleteElement":             {strangeSyntaxSrc, "SliceDeleteElement", nil, strange_syntax.SliceDeleteElement},
		"MapWithStructValue":             {strangeSyntaxSrc, "MapWithStructValue", nil, strange_syntax.MapWithStructValue},
		"ChannelSendReceiveBuffered":     {strangeSyntaxSrc, "ChannelSendReceiveBuffered", nil, strange_syntax.ChannelSendReceiveBuffered},
		"MultipleReturnAssign":           {strangeSyntaxSrc, "MultipleReturnAssign", nil, strange_syntax.MultipleReturnAssign},
		"NamedReturnBare":                {strangeSyntaxSrc, "NamedReturnBare", nil, strange_syntax.NamedReturnBare},
		"TypeConversionChain":            {strangeSyntaxSrc, "TypeConversionChain", nil, strange_syntax.TypeConversionChain},
		"StructPointerMethodOnValue":     {strangeSyntaxSrc, "StructPointerMethodOnValue", nil, strange_syntax.StructPointerMethodOnValue},
		"SliceFromToArray":               {strangeSyntaxSrc, "SliceFromToArray", nil, strange_syntax.SliceFromToArray},
		"MapAccessTwoValue":              {strangeSyntaxSrc, "MapAccessTwoValue", nil, strange_syntax.MapAccessTwoValue},
		"MapAccessTwoValueMissing":       {strangeSyntaxSrc, "MapAccessTwoValueMissing", nil, strange_syntax.MapAccessTwoValueMissing},
		"DeferArgumentsEvaluatedAtCall":  {strangeSyntaxSrc, "DeferArgumentsEvaluatedAtCall", nil, strange_syntax.DeferArgumentsEvaluatedAtCall},
		"StringConcatEmpty":              {strangeSyntaxSrc, "StringConcatEmpty", nil, strange_syntax.StringConcatEmpty},
		"SliceOfSliceAppend":             {strangeSyntaxSrc, "SliceOfSliceAppend", nil, strange_syntax.SliceOfSliceAppend},
		"InterfaceSliceAccess":           {strangeSyntaxSrc, "InterfaceSliceAccess", nil, strange_syntax.InterfaceSliceAccess},
		"PointerNilCheck":                {strangeSyntaxSrc, "PointerNilCheck", nil, strange_syntax.PointerNilCheck},
		"StructZeroValueFields":          {strangeSyntaxSrc, "StructZeroValueFields", nil, strange_syntax.StructZeroValueFields},
		"RangeOverNilMap":                {strangeSyntaxSrc, "RangeOverNilMap", nil, strange_syntax.RangeOverNilMap},
		"RangeOverNilSlice":              {strangeSyntaxSrc, "RangeOverNilSlice", nil, strange_syntax.RangeOverNilSlice},
		"SliceCapAfterAppend":            {strangeSyntaxSrc, "SliceCapAfterAppend", nil, strange_syntax.SliceCapAfterAppend},
		"MapAssignExisting":              {strangeSyntaxSrc, "MapAssignExisting", nil, strange_syntax.MapAssignExisting},
		"StructCompareDifferentValues":   {strangeSyntaxSrc, "StructCompareDifferentValues", nil, strange_syntax.StructCompareDifferentValues},
		"DeferModifyNamedReturn":         {strangeSyntaxSrc, "DeferModifyNamedReturn", nil, strange_syntax.DeferModifyNamedReturn},
		"ChannelCloseAndLen":             {strangeSyntaxSrc, "ChannelCloseAndLen", nil, strange_syntax.ChannelCloseAndLen},
		"MultipleShortVarDecl":           {strangeSyntaxSrc, "MultipleShortVarDecl", nil, strange_syntax.MultipleShortVarDecl},
		"StructEmbedShadow":              {strangeSyntaxSrc, "StructEmbedShadow", nil, strange_syntax.StructEmbedShadow},
		...
		// TreeWithParentRef is covered by the resolved issue regression suite.
		...
		// CombinedDeferWithIO is covered by the resolved issue regression suite.
		...
		// ============================================================================
		"SliceShareModifyR14":             {strangeSyntaxSrc, "SliceShareModifyR14", nil, strange_syntax.SliceShareModifyR14},
		"SliceAppendOverwriteR14":         {strangeSyntaxSrc, "SliceAppendOverwriteR14", nil, strange_syntax.SliceAppendOverwriteR14},
		"MapDeleteAndReadR14":             {strangeSyntaxSrc, "MapDeleteAndReadR14", nil, strange_syntax.MapDeleteAndReadR14},
		"MapLenAfterDeletesR14":           {strangeSyntaxSrc, "MapLenAfterDeletesR14", nil, strange_syntax.MapLenAfterDeletesR14},
		"PointerReassignR14":              {strangeSyntaxSrc, "PointerReassignR14", nil, strange_syntax.PointerReassignR14},
		"DoublePointerR14":                {strangeSyntaxSrc, "DoublePointerR14", nil, strange_syntax.DoublePointerR14},
		"SliceOfPointersR14":              {strangeSyntaxSrc, "SliceOfPointersR14", nil, strange_syntax.SliceOfPointersR14},
		"MapOfSlicesR14":                  {strangeSyntaxSrc, "MapOfSlicesR14", nil, strange_syntax.MapOfSlicesR14},
		"MapOfMapsR14":                    {strangeSyntaxSrc, "MapOfMapsR14", nil, strange_syntax.MapOfMapsR14},
		"NestedMapLookupR14":              {strangeSyntaxSrc, "NestedMapLookupR14", nil, strange_syntax.NestedMapLookupR14},
		"StringIndexR14":                  {strangeSyntaxSrc, "StringIndexR14", nil, strange_syntax.StringIndexR14},
		"RuneRangeStringR14":              {strangeSyntaxSrc, "RuneRangeStringR14", nil, strange_syntax.RuneRangeStringR14},
		"SliceCopyBuiltInR14":             {strangeSyntaxSrc, "SliceCopyBuiltInR14", nil, strange_syntax.SliceCopyBuiltInR14},
		"AppendByteSliceR14":              {strangeSyntaxSrc, "AppendByteSliceR14", nil, strange_syntax.AppendByteSliceR14},
		"StructCompareEqualR14":           {strangeSyntaxSrc, "StructCompareEqualR14", nil, strange_syntax.StructCompareEqualR14},
		"StructCompareNotEqualR14":        {strangeSyntaxSrc, "StructCompareNotEqualR14", nil, strange_syntax.StructCompareNotEqualR14},
		"ArrayAssignCopyR14":              {strangeSyntaxSrc, "ArrayAssignCopyR14", nil, strange_syntax.ArrayAssignCopyR14},
		"SliceNilSubsliceR14":             {strangeSyntaxSrc, "SliceNilSubsliceR14", nil, strange_syntax.SliceNilSubsliceR14},
		"MapKeyPointerR14":                {strangeSyntaxSrc, "MapKeyPointerR14", nil, strange_syntax.MapKeyPointerR14},
		"ChannelCloseThenCapR14":          {strangeSyntaxSrc, "ChannelCloseThenCapR14", nil, strange_syntax.ChannelCloseThenCapR14},
		"TypeSwitchDefaultR14":            {strangeSyntaxSrc, "TypeSwitchDefaultR14", nil, strange_syntax.TypeSwitchDefaultR14},
		"InterfaceNilComparisonR14":       {strangeSyntaxSrc, "InterfaceNilComparisonR14", nil, strange_syntax.InterfaceNilComparisonR14},
		"SliceGrowFactorR14":              {strangeSyntaxSrc, "SliceGrowFactorR14", nil, strange_syntax.SliceGrowFactorR14},
		"MapPreAllocR14":                  {strangeSyntaxSrc, "MapPreAllocR14", nil, strange_syntax.MapPreAllocR14},
		"StructAnonymousFieldR14":         {strangeSyntaxSrc, "StructAnonymousFieldR14", nil, strange_syntax.StructAnonymousFieldR14},
		"PointerSliceModifyR14":           {strangeSyntaxSrc, "PointerSliceModifyR14", nil, strange_syntax.PointerSliceModifyR14},
		"MapIterateDeleteR14":             {strangeSyntaxSrc, "MapIterateDeleteR14", nil, strange_syntax.MapIterateDeleteR14},
		"SliceThreeIndexR14":              {strangeSyntaxSrc, "SliceThreeIndexR14", nil, strange_syntax.SliceThreeIndexR14},
		"ArrayPointerIndexR14":            {strangeSyntaxSrc, "ArrayPointerIndexR14", nil, strange_syntax.ArrayPointerIndexR14},
		"StringByteSliceConvR14":          {strangeSyntaxSrc, "StringByteSliceConvR14", nil, strange_syntax.StringByteSliceConvR14},
		"RuneSliceStringConvR14":          {strangeSyntaxSrc, "RuneSliceStringConvR14", nil, strange_syntax.RuneSliceStringConvR14},
		"ClosureReadBeforeWriteR14":       {strangeSyntaxSrc, "ClosureReadBeforeWriteR14", nil, strange_syntax.ClosureReadBeforeWriteR14},
		"MultiAssignDifferentTypesR14":    {strangeSyntaxSrc, "MultiAssignDifferentTypesR14", nil, strange_syntax.MultiAssignDifferentTypesR14},
		"SwapViaTupleR14":                 {strangeSyntaxSrc, "SwapViaTupleR14", nil, strange_syntax.SwapViaTupleR14},
		"MapLookupOrDefaultR14":           {strangeSyntaxSrc, "MapLookupOrDefaultR14", nil, strange_syntax.MapLookupOrDefaultR14},
		"SliceRemovePreserveOrderR14":     {strangeSyntaxSrc, "SliceRemovePreserveOrderR14", nil, strange_syntax.SliceRemovePreserveOrderR14},
		"NestedStructLiteralR14":          {strangeSyntaxSrc, "NestedStructLiteralR14", nil, strange_syntax.NestedStructLiteralR14},
		"SliceOfStringPointersR14":        {strangeSyntaxSrc, "SliceOfStringPointersR14", nil, strange_syntax.SliceOfStringPointersR14},
		"MapOfFuncValuesR14":              {strangeSyntaxSrc, "MapOfFuncValuesR14", nil, strange_syntax.MapOfFuncValuesR14},
		"StructPromotedMethodR14":         {strangeSyntaxSrc, "StructPromotedMethodR14", nil, strange_syntax.StructPromotedMethodR14},
		"InterfaceSliceOfTypeR14":         {strangeSyntaxSrc, "InterfaceSliceOfTypeR14", nil, strange_syntax.InterfaceSliceOfTypeR14},
		"ChannelDrainAfterCloseR14":       {strangeSyntaxSrc, "ChannelDrainAfterCloseR14", nil, strange_syntax.ChannelDrainAfterCloseR14},
		"MapWithEmptyStructKeyR14":        {strangeSyntaxSrc, "MapWithEmptyStructKeyR14", nil, strange_syntax.MapWithEmptyStructKeyR14},
		"PointerToSliceR14":               {strangeSyntaxSrc, "PointerToSliceR14", nil, strange_syntax.PointerToSliceR14},
		"SliceReverseR14":                 {strangeSyntaxSrc, "SliceReverseR14", nil, strange_syntax.SliceReverseR14},
		"ClosureCapturesNewVarR14":        {strangeSyntaxSrc, "ClosureCapturesNewVarR14", nil, strange_syntax.ClosureCapturesNewVarR14},
		"MapClearAndReuseR14":             {strangeSyntaxSrc, "MapClearAndReuseR14", nil, strange_syntax.MapClearAndReuseR14},
		"SliceOfChannelsR14":              {strangeSyntaxSrc, "SliceOfChannelsR14", nil, strange_syntax.SliceOfChannelsR14},
		"TypeAssertionMethodCallR14":      {strangeSyntaxSrc, "TypeAssertionMethodCallR14", nil, strange_syntax.TypeAssertionMethodCallR14},
		"NestedForBreakLabelR14":          {strangeSyntaxSrc, "NestedForBreakLabelR14", nil, strange_syntax.NestedForBreakLabelR14},
		"RangeOverArrayR14":               {strangeSyntaxSrc, "RangeOverArrayR14", nil, strange_syntax.RangeOverArrayR14},
		"MapValueIsSliceR14":              {strangeSyntaxSrc, "MapValueIsSliceR14", nil, strange_syntax.MapValueIsSliceR14},
		"PointerSwapR14":                  {strangeSyntaxSrc, "PointerSwapR14", nil, strange_syntax.PointerSwapR14},
		"SliceFromArrayOfIntR14":          {strangeSyntaxSrc, "SliceFromArrayOfIntR14", nil, strange_syntax.SliceFromArrayOfIntR14},
		"StructWithEmbeddedSliceR14":      {strangeSyntaxSrc, "StructWithEmbeddedSliceR14", nil, strange_syntax.StructWithEmbeddedSliceR14},
		"InterfaceAssertToPointerR14":     {strangeSyntaxSrc, "InterfaceAssertToPointerR14", nil, strange_syntax.InterfaceAssertToPointerR14},
		"MapKeyIsStringR14":               {strangeSyntaxSrc, "MapKeyIsStringR14", nil, strange_syntax.MapKeyIsStringR14},
		"SliceCapVsLenR14":                {strangeSyntaxSrc, "SliceCapVsLenR14", nil, strange_syntax.SliceCapVsLenR14},
		"StructMethodReturnsSelfR14":      {strangeSyntaxSrc, "StructMethodReturnsSelfR14", nil, strange_syntax.StructMethodReturnsSelfR14},
		"ClosureAsArgumentR14":            {strangeSyntaxSrc, "ClosureAsArgumentR14", nil, strange_syntax.ClosureAsArgumentR14},
		"MapWithInterfaceKeyR14":          {strangeSyntaxSrc, "MapWithInterfaceKeyR14", nil, strange_syntax.MapWithInterfaceKeyR14},
		"SliceInsertMiddleR14":            {strangeSyntaxSrc, "SliceInsertMiddleR14", nil, strange_syntax.SliceInsertMiddleR14},
		"PointerDerefAssignR14":           {strangeSyntaxSrc, "PointerDerefAssignR14", nil, strange_syntax.PointerDerefAssignR14},
		"RangeOverStringR14":              {strangeSyntaxSrc, "RangeOverStringR14", nil, strange_syntax.RangeOverStringR14},
		"MapWithBoolKeyR14":               {strangeSyntaxSrc, "MapWithBoolKeyR14", nil, strange_syntax.MapWithBoolKeyR14},
		"SliceOfStructLiteralR14":         {strangeSyntaxSrc, "SliceOfStructLiteralR14", nil, strange_syntax.SliceOfStructLiteralR14},
		"ChannelAsReturnR14":              {strangeSyntaxSrc, "ChannelAsReturnR14", nil, strange_syntax.ChannelAsReturnR14},
		"StructEmbedMethodOverrideR14":    {strangeSyntaxSrc, "StructEmbedMethodOverrideR14", nil, strange_syntax.StructEmbedMethodOverrideR14},
		"InterfaceTypeSwitchR14":          {strangeSyntaxSrc, "InterfaceTypeSwitchR14", nil, strange_syntax.InterfaceTypeSwitchR14},
		"SliceFilterPatternR14":           {strangeSyntaxSrc, "SliceFilterPatternR14", nil, strange_syntax.SliceFilterPatternR14},
		"PointerMethodOnStructR14":        {strangeSyntaxSrc, "PointerMethodOnStructR14", nil, strange_syntax.PointerMethodOnStructR14},
		"MapDeleteNonExistentR14":         {strangeSyntaxSrc, "MapDeleteNonExistentR14", nil, strange_syntax.MapDeleteNonExistentR14},
		"SliceAppendNilR14":               {strangeSyntaxSrc, "SliceAppendNilR14", nil, strange_syntax.SliceAppendNilR14},
		"StructWithSliceOfSelfR14":        {strangeSyntaxSrc, "StructWithSliceOfSelfR14", nil, strange_syntax.StructWithSliceOfSelfR14},
		"ClosureCounterR14":               {strangeSyntaxSrc, "ClosureCounterR14", nil, strange_syntax.ClosureCounterR14},
		"MapMergeR14":                     {strangeSyntaxSrc, "MapMergeR14", nil, strange_syntax.MapMergeR14},
		"SliceDedupeR14":                  {strangeSyntaxSrc, "SliceDedupeR14", nil, strange_syntax.SliceDedupeR14},
		"ChannelRangeAfterCloseR14":       {strangeSyntaxSrc, "ChannelRangeAfterCloseR14", nil, strange_syntax.ChannelRangeAfterCloseR14},
		"TypeConversionStringToIntR14":    {strangeSyntaxSrc, "TypeConversionStringToIntR14", nil, strange_syntax.TypeConversionStringToIntR14},
		"PointerToMapR14":                 {strangeSyntaxSrc, "PointerToMapR14", nil, strange_syntax.PointerToMapR14},
		"SliceCopyViaAssignmentR14":       {strangeSyntaxSrc, "SliceCopyViaAssignmentR14", nil, strange_syntax.SliceCopyViaAssignmentR14},
		"MapUpdateExistingKeyR14":         {strangeSyntaxSrc, "MapUpdateExistingKeyR14", nil, strange_syntax.MapUpdateExistingKeyR14},
		"StructMethodChainR14":            {strangeSyntaxSrc, "StructMethodChainR14", nil, strange_syntax.StructMethodChainR14},
		"InterfaceEmptyVsNilR14":          {strangeSyntaxSrc, "InterfaceEmptyVsNilR14", nil, strange_syntax.InterfaceEmptyVsNilR14},
		"SliceMapTransformR14":            {strangeSyntaxSrc, "SliceMapTransformR14", nil, strange_syntax.SliceMapTransformR14},
		"PointerIncrementR14":             {strangeSyntaxSrc, "PointerIncrementR14", nil, strange_syntax.PointerIncrementR14},
		"SliceZeroLenNonNilR14":           {strangeSyntaxSrc, "SliceZeroLenNonNilR14", nil, strange_syntax.SliceZeroLenNonNilR14},
		"MapReadWriteModifyR14":           {strangeSyntaxSrc, "MapReadWriteModifyR14", nil, strange_syntax.MapReadWriteModifyR14},
		"StructFieldPointerR14":           {strangeSyntaxSrc, "StructFieldPointerR14", nil, strange_syntax.StructFieldPointerR14},
		"SliceOfMapsR14":                  {strangeSyntaxSrc, "SliceOfMapsR14", nil, strange_syntax.SliceOfMapsR14},
		"NestedSliceAccessR14":            {strangeSyntaxSrc, "NestedSliceAccessR14", nil, strange_syntax.NestedSliceAccessR14},
		"MapKeyIntFloatR14":               {strangeSyntaxSrc, "MapKeyIntFloatR14", nil, strange_syntax.MapKeyIntFloatR14},
		"StructCompareDifferentFieldsR14": {strangeSyntaxSrc, "StructCompareDifferentFieldsR14", nil, strange_syntax.StructCompareDifferentFieldsR14},
		"ChannelSelectWithTwoR14":         {strangeSyntaxSrc, "ChannelSelectWithTwoR14", nil, strange_syntax.ChannelSelectWithTwoR14},
		"SliceFromSliceR14":               {strangeSyntaxSrc, "SliceFromSliceR14", nil, strange_syntax.SliceFromSliceR14},
		"MapLenZeroR14":                   {strangeSyntaxSrc, "MapLenZeroR14", nil, strange_syntax.MapLenZeroR14},
		"StructPointerNilCheckR14":        {strangeSyntaxSrc, "StructPointerNilCheckR14", nil, strange_syntax.StructPointerNilCheckR14},
		"SliceAppendMultipleR14":          {strangeSyntaxSrc, "SliceAppendMultipleR14", nil, strange_syntax.SliceAppendMultipleR14},
		"MapAccessDefaultR14":             {strangeSyntaxSrc, "MapAccessDefaultR14", nil, strange_syntax.MapAccessDefaultR14},
		"StructEmbedFieldAccessR14":       {strangeSyntaxSrc, "StructEmbedFieldAccessR14", nil, strange_syntax.StructEmbedFieldAccessR14},
		"ClosureOverSliceR14":             {strangeSyntaxSrc, "ClosureOverSliceR14", nil, strange_syntax.ClosureOverSliceR14},
		"MapSizeAfterClearR14":            {strangeSyntaxSrc, "MapSizeAfterClearR14", nil, strange_syntax.MapSizeAfterClearR14},
		"SliceOfBoolR14":                  {strangeSyntaxSrc, "SliceOfBoolR14", nil, strange_syntax.SliceOfBoolR14},
		"StructZeroValCheckR14":           {strangeSyntaxSrc, "StructZeroValCheckR14", nil, strange_syntax.StructZeroValCheckR14},
		"MapWithIntKeyStringValR14":       {strangeSyntaxSrc, "MapWithIntKeyStringValR14", nil, strange_syntax.MapWithIntKeyStringValR14},
		"SliceCopyFullR14":                {strangeSyntaxSrc, "SliceCopyFullR14", nil, strange_syntax.SliceCopyFullR14},
		"StructPointerModifyFieldR14":     {strangeSyntaxSrc, "StructPointerModifyFieldR14", nil, strange_syntax.StructPointerModifyFieldR14},
		"NestedMapDeleteR14":              {strangeSyntaxSrc, "NestedMapDeleteR14", nil, strange_syntax.NestedMapDeleteR14},
		"SliceOfStringR14":                {strangeSyntaxSrc, "SliceOfStringR14", nil, strange_syntax.SliceOfStringR14},
		"MapRangeOrderIndependentR14":     {strangeSyntaxSrc, "MapRangeOrderIndependentR14", nil, strange_syntax.MapRangeOrderIndependentR14},

		// ============================================================================
		// ROUND 15: variadic, select, control flow, numeric, string edge cases
		// ============================================================================
		"VariadicWithNilR15":                {strangeSyntaxSrc, "VariadicWithNilR15", nil, strange_syntax.VariadicWithNilR15},
		"VariadicSpreadR15":                 {strangeSyntaxSrc, "VariadicSpreadR15", nil, strange_syntax.VariadicSpreadR15},
		"SelectWithDefaultOnlyR15":          {strangeSyntaxSrc, "SelectWithDefaultOnlyR15", nil, strange_syntax.SelectWithDefaultOnlyR15},
		"NestedSelectR15":                   {strangeSyntaxSrc, "NestedSelectR15", nil, strange_syntax.NestedSelectR15},
		"ForBreakContinueR15":               {strangeSyntaxSrc, "ForBreakContinueR15", nil, strange_syntax.ForBreakContinueR15},
		"SwitchWithNoCasesR15":              {strangeSyntaxSrc, "SwitchWithNoCasesR15", nil, strange_syntax.SwitchWithNoCasesR15},
		"MultipleShortVarDeclSameNameR15":   {strangeSyntaxSrc, "MultipleShortVarDeclSameNameR15", nil, strange_syntax.MultipleShortVarDeclSameNameR15},
		"PointerToPointerDerefR15":          {strangeSyntaxSrc, "PointerToPointerDerefR15", nil, strange_syntax.PointerToPointerDerefR15},
		"SliceOfFuncsR15":                   {strangeSyntaxSrc, "SliceOfFuncsR15", nil, strange_syntax.SliceOfFuncsR15},
		"MapDeleteAllR15":                   {strangeSyntaxSrc, "MapDeleteAllR15", nil, strange_syntax.MapDeleteAllR15},
		"StringConcatR15":                   {strangeSyntaxSrc, "StringConcatR15", nil, strange_syntax.StringConcatR15},
		"StringIndexByteR15":                {strangeSyntaxSrc, "StringIndexByteR15", nil, strange_syntax.StringIndexByteR15},
		"RuneLenR15":                        {strangeSyntaxSrc, "RuneLenR15", nil, strange_syntax.RuneLenR15},
		"NumericOverflowR15":                {strangeSyntaxSrc, "NumericOverflowR15", nil, strange_syntax.NumericOverflowR15},
		"FloatComparisonR15":                {strangeSyntaxSrc, "FloatComparisonR15", nil, strange_syntax.FloatComparisonR15},
		"StructLiteralWithoutFieldNamesR15": {strangeSyntaxSrc, "StructLiteralWithoutFieldNamesR15", nil, strange_syntax.StructLiteralWithoutFieldNamesR15},
		"SliceFromSliceSharedR15":           {strangeSyntaxSrc, "SliceFromSliceSharedR15", nil, strange_syntax.SliceFromSliceSharedR15},
		"MapTwoValueDeleteR15":              {strangeSyntaxSrc, "MapTwoValueDeleteR15", nil, strange_syntax.MapTwoValueDeleteR15},
		"NilMapWritePanicR15":               {strangeSyntaxSrc, "NilMapWritePanicR15", nil, strange_syntax.NilMapWritePanicR15},
		"ArrayLenCapR15":                    {strangeSyntaxSrc, "ArrayLenCapR15", nil, strange_syntax.ArrayLenCapR15},
		"SliceMakeLenCapR15":                {strangeSyntaxSrc, "SliceMakeLenCapR15", nil, strange_syntax.SliceMakeLenCapR15},
		"ChannelDirR15":                     {strangeSyntaxSrc, "ChannelDirR15", nil, strange_syntax.ChannelDirR15},
		"InterfaceConvertToInterfaceR15":    {strangeSyntaxSrc, "InterfaceConvertToInterfaceR15", nil, strange_syntax.InterfaceConvertToInterfaceR15},
		"SliceAppendNilSliceR15":            {strangeSyntaxSrc, "SliceAppendNilSliceR15", nil, strange_syntax.SliceAppendNilSliceR15},
		"MapWithFloatKeyR15":                {strangeSyntaxSrc, "MapWithFloatKeyR15", nil, strange_syntax.MapWithFloatKeyR15},
		"StructFieldSliceAppendR15":         {strangeSyntaxSrc, "StructFieldSliceAppendR15", nil, strange_syntax.StructFieldSliceAppendR15},
		"PointerMethodValueReceiverR15":     {strangeSyntaxSrc, "PointerMethodValueReceiverR15", nil, strange_syntax.PointerMethodValueReceiverR15},
		"ClosureCaptureTwoVarsR15":          {strangeSyntaxSrc, "ClosureCaptureTwoVarsR15", nil, strange_syntax.ClosureCaptureTwoVarsR15},
		"MultiReturnInIfR15":                {strangeSyntaxSrc, "MultiReturnInIfR15", nil, strange_syntax.MultiReturnInIfR15},
		"SliceOfEmptyStructR15":             {strangeSyntaxSrc, "SliceOfEmptyStructR15", nil, strange_syntax.SliceOfEmptyStructR15},
		"MapWithArrayKeyR15":                {strangeSyntaxSrc, "MapWithArrayKeyR15", nil, strange_syntax.MapWithArrayKeyR15},
		"SwitchCaseMultipleR15":             {strangeSyntaxSrc, "SwitchCaseMultipleR15", nil, strange_syntax.SwitchCaseMultipleR15},
		"RangeOverNilChannelR15":            {strangeSyntaxSrc, "RangeOverNilChannelR15", nil, strange_syntax.RangeOverNilChannelR15},
		"SliceCopyOverlapR15":               {strangeSyntaxSrc, "SliceCopyOverlapR15", nil, strange_syntax.SliceCopyOverlapR15},
		"StructCompareSameR15":              {strangeSyntaxSrc, "StructCompareSameR15", nil, strange_syntax.StructCompareSameR15},
		"TypeAssertionOnNilR15":             {strangeSyntaxSrc, "TypeAssertionOnNilR15", nil, strange_syntax.TypeAssertionOnNilR15},
		"MapLenAfterAssignR15":              {strangeSyntaxSrc, "MapLenAfterAssignR15", nil, strange_syntax.MapLenAfterAssignR15},
		"SliceOfStringConcatR15":            {strangeSyntaxSrc, "SliceOfStringConcatR15", nil, strange_syntax.SliceOfStringConcatR15},
		"PointerToStructLiteralR15":         {strangeSyntaxSrc, "PointerToStructLiteralR15", nil, strange_syntax.PointerToStructLiteralR15},
		"ChannelCloseAndDrainR15":           {strangeSyntaxSrc, "ChannelCloseAndDrainR15", nil, strange_syntax.ChannelCloseAndDrainR15},
		"SliceModifyOriginalR15":            {strangeSyntaxSrc, "SliceModifyOriginalR15", nil, strange_syntax.SliceModifyOriginalR15},
		"MapKeyStructR15":                   {strangeSyntaxSrc, "MapKeyStructR15", nil, strange_syntax.MapKeyStructR15},
		"ForRangeIndexOnlyR15":              {strangeSyntaxSrc, "ForRangeIndexOnlyR15", nil, strange_syntax.ForRangeIndexOnlyR15},
		"NilSliceComparisonR15":             {strangeSyntaxSrc, "NilSliceComparisonR15", nil, strange_syntax.NilSliceComparisonR15},
		"StructEmbedMethodCallR15":          {strangeSyntaxSrc, "StructEmbedMethodCallR15", nil, strange_syntax.StructEmbedMethodCallR15},
		"InterfaceSliceLenR15":              {strangeSyntaxSrc, "InterfaceSliceLenR15", nil, strange_syntax.InterfaceSliceLenR15},
		"MapRangeCountR15":                  {strangeSyntaxSrc, "MapRangeCountR15", nil, strange_syntax.MapRangeCountR15},
		"SliceCapAfterResliceR15":           {strangeSyntaxSrc, "SliceCapAfterResliceR15", nil, strange_syntax.SliceCapAfterResliceR15},
		"StringEmptyComparisonR15":          {strangeSyntaxSrc, "StringEmptyComparisonR15", nil, strange_syntax.StringEmptyComparisonR15},
		"MapValueNilInterfaceR15":           {strangeSyntaxSrc, "MapValueNilInterfaceR15", nil, strange_syntax.MapValueNilInterfaceR15},
		"SliceAppendSelfR15":                {strangeSyntaxSrc, "SliceAppendSelfR15", nil, strange_syntax.SliceAppendSelfR15},
		"StructFieldMapR15":                 {strangeSyntaxSrc, "StructFieldMapR15", nil, strange_syntax.StructFieldMapR15},
		"PointerAssignNilR15":               {strangeSyntaxSrc, "PointerAssignNilR15", nil, strange_syntax.PointerAssignNilR15},
		"MapAccessEmptyR15":                 {strangeSyntaxSrc, "MapAccessEmptyR15", nil, strange_syntax.MapAccessEmptyR15},
		"SliceOfSliceR15":                   {strangeSyntaxSrc, "SliceOfSliceR15", nil, strange_syntax.SliceOfSliceR15},
		"SwitchNoConditionR15":              {strangeSyntaxSrc, "SwitchNoConditionR15", nil, strange_syntax.SwitchNoConditionR15},
		"MapIntIntR15":                      {strangeSyntaxSrc, "MapIntIntR15", nil, strange_syntax.MapIntIntR15},
		"StructZeroValueComparisonR15":      {strangeSyntaxSrc, "StructZeroValueComparisonR15", nil, strange_syntax.StructZeroValueComparisonR15},
		"ChannelNilBlockR15":                {strangeSyntaxSrc, "ChannelNilBlockR15", nil, strange_syntax.ChannelNilBlockR15},
		"SliceRangeModifyR15":               {strangeSyntaxSrc, "SliceRangeModifyR15", nil, strange_syntax.SliceRangeModifyR15},
		"StringSliceR15":                    {strangeSyntaxSrc, "StringSliceR15", nil, strange_syntax.StringSliceR15},
		"MapKeyTypeSwitchR15":               {strangeSyntaxSrc, "MapKeyTypeSwitchR15", nil, strange_syntax.MapKeyTypeSwitchR15},
		"StructFieldChannelR15":             {strangeSyntaxSrc, "StructFieldChannelR15", nil, strange_syntax.StructFieldChannelR15},
		"PointerSliceOfStructR15":           {strangeSyntaxSrc, "PointerSliceOfStructR15", nil, strange_syntax.PointerSliceOfStructR15},
		"MapStringKeyR15":                   {strangeSyntaxSrc, "MapStringKeyR15", nil, strange_syntax.MapStringKeyR15},
		"SliceDeleteFirstR15":               {strangeSyntaxSrc, "SliceDeleteFirstR15", nil, strange_syntax.SliceDeleteFirstR15},
		"RangeOverSliceIndexValueR15":       {strangeSyntaxSrc, "RangeOverSliceIndexValueR15", nil, strange_syntax.RangeOverSliceIndexValueR15},
		"NilPointerDerefGuardR15":           {strangeSyntaxSrc, "NilPointerDerefGuardR15", nil, strange_syntax.NilPointerDerefGuardR15},
		"MapWriteReadR15":                   {strangeSyntaxSrc, "MapWriteReadR15", nil, strange_syntax.MapWriteReadR15},
		"SliceLenZeroR15":                   {strangeSyntaxSrc, "SliceLenZeroR15", nil, strange_syntax.SliceLenZeroR15},
		"StructEmbeddedPointerNilR15":       {strangeSyntaxSrc, "StructEmbeddedPointerNilR15", nil, strange_syntax.StructEmbeddedPointerNilR15},
		"ChannelSelectPriorityR15":          {strangeSyntaxSrc, "ChannelSelectPriorityR15", nil, strange_syntax.ChannelSelectPriorityR15},
		"SliceOfInterfaceNilR15":            {strangeSyntaxSrc, "SliceOfInterfaceNilR15", nil, strange_syntax.SliceOfInterfaceNilR15},
		"MapDeleteAndReinsertR15":           {strangeSyntaxSrc, "MapDeleteAndReinsertR15", nil, strange_syntax.MapDeleteAndReinsertR15},
		"StructLiteralWithFieldsR15":        {strangeSyntaxSrc, "StructLiteralWithFieldsR15", nil, strange_syntax.StructLiteralWithFieldsR15},
		"PointerSwapValuesR15":              {strangeSyntaxSrc, "PointerSwapValuesR15", nil, strange_syntax.PointerSwapValuesR15},
		"MapRangeDeleteSafeR15":             {strangeSyntaxSrc, "MapRangeDeleteSafeR15", nil, strange_syntax.MapRangeDeleteSafeR15},
		"SliceMakeZeroLenR15":               {strangeSyntaxSrc, "SliceMakeZeroLenR15", nil, strange_syntax.SliceMakeZeroLenR15},
		"StringRangeR15":                    {strangeSyntaxSrc, "StringRangeR15", nil, strange_syntax.StringRangeR15},
		"StructMethodOnNilPointerR15":       {strangeSyntaxSrc, "StructMethodOnNilPointerR15", nil, strange_syntax.StructMethodOnNilPointerR15},
		"MapWithStructValR15":               {strangeSyntaxSrc, "MapWithStructValR15", nil, strange_syntax.MapWithStructValR15},
		"ChannelClosedRecvZeroR15":          {strangeSyntaxSrc, "ChannelClosedRecvZeroR15", nil, strange_syntax.ChannelClosedRecvZeroR15},
		"SliceAppendExpandR15":              {strangeSyntaxSrc, "SliceAppendExpandR15", nil, strange_syntax.SliceAppendExpandR15},
		"MapNilReadR15":                     {strangeSyntaxSrc, "MapNilReadR15", nil, strange_syntax.MapNilReadR15},
		"StructFieldModifyR15":              {strangeSyntaxSrc, "StructFieldModifyR15", nil, strange_syntax.StructFieldModifyR15},
		"PointerToChannelR15":               {strangeSyntaxSrc, "PointerToChannelR15", nil, strange_syntax.PointerToChannelR15},
		"SliceOfBoolLenR15":                 {strangeSyntaxSrc, "SliceOfBoolLenR15", nil, strange_syntax.SliceOfBoolLenR15},
		"MapInterfaceValR15":                {strangeSyntaxSrc, "MapInterfaceValR15", nil, strange_syntax.MapInterfaceValR15},
		"StringRuneAtIndexR15":              {strangeSyntaxSrc, "StringRuneAtIndexR15", nil, strange_syntax.StringRuneAtIndexR15},
		"StructEmbeddedInterfaceR15":        {strangeSyntaxSrc, "StructEmbeddedInterfaceR15", nil, strange_syntax.StructEmbeddedInterfaceR15},
		"MapTwoValLookupR15":                {strangeSyntaxSrc, "MapTwoValLookupR15", nil, strange_syntax.MapTwoValLookupR15},
		"SliceGrowWithAppendR15":            {strangeSyntaxSrc, "SliceGrowWithAppendR15", nil, strange_syntax.SliceGrowWithAppendR15},
		"NilInterfaceMethodGuardR15":        {strangeSyntaxSrc, "NilInterfaceMethodGuardR15", nil, strange_syntax.NilInterfaceMethodGuardR15},
		"MapWithStringKeyLenR15":            {strangeSyntaxSrc, "MapWithStringKeyLenR15", nil, strange_syntax.MapWithStringKeyLenR15},
		"SliceOfIntSumR15":                  {strangeSyntaxSrc, "SliceOfIntSumR15", nil, strange_syntax.SliceOfIntSumR15},
		"StructPointerEmbeddedR15":          {strangeSyntaxSrc, "StructPointerEmbeddedR15", nil, strange_syntax.StructPointerEmbeddedR15},
		"ChannelSendRecvOrderR15":           {strangeSyntaxSrc, "ChannelSendRecvOrderR15", nil, strange_syntax.ChannelSendRecvOrderR15},
...
// TestStrangeSyntaxResolvedIssues keeps regression coverage for cases that
// previously failed due to interpreter limitations.
func TestStrangeSyntaxResolvedIssues(t *testing.T) {
	// Resolved issues:
	// 1. TreeWithParentRef - self-referential struct with slice field.
	// 2. CombinedDeferWithIO - defer with external type methods.
	// Note: XMLEmbeddedStruct and GobRecursiveStructure removed — encoding/xml and encoding/gob dropped.

	resolvedIssueTests := map[string]testCase{
		"TreeWithParentRef":   {strangeSyntaxResolvedIssueSrc, "TreeWithParentRef", nil, strange_syntax_known_issue.TreeWithParentRef},
		"CombinedDeferWithIO": {strangeSyntaxResolvedIssueSrc, "CombinedDeferWithIO", nil, strange_syntax_known_issue.CombinedDeferWithIO},
	}

	runTestSet(t, testSet{src: strangeSyntaxResolvedIssueSrc, tests: resolvedIssueTests})
}
